...
The concept is explored in the paper *"Towards Zero-Shot Vision-Language Navigation"* ([[arXiv:2211.16649]] ⚠️), which demonstrates that agents can generalize to new instructions and scenes zero-shot by combining pre-trained components like [[CLIP]] or [[GPT-based Scene Graph]] ⚠️ with classical [[Sim-to-Real Transfer|sim-to-real]] techniques.
