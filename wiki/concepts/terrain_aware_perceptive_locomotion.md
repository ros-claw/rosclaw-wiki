...
Both paradigms can be combined with Reinforcement Learning to train policies in simulation and then transferred to real robots.

## Capabilities

- Enables legged robots to safely traverse diverse terrains (e.g., gravel, stairs, slopes, debris) without prior knowledge of the environment.
