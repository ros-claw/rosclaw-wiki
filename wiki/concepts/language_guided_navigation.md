...
Language-Guided Navigation implements ⚠️ ⚠️ the ability to follow free-form language instructions. The agent must map linguistic descriptions (e.g., "turn left after the red building") to actionable spatial paths, handling variations in phrasing, reference frames, and environmental clutter.
