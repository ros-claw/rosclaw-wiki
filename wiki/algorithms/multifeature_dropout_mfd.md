...
MFD is a key component of the [[PASTS|PASTS (Progress-Aware Spatio-Temporal Transformer Speaker)]] framework, where it contributes to the overall robustness and generalization performance of the system. In particular, MFD is used to alleviate overfitting during the training of speaker models within the PASTS architecture.
